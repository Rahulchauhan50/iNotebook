                    ...
                    <div className='h-full min-h-screen bg-[#15202b]'>
                        ...
                        <div className='md:w-[90%] w-[95%] mx-auto mt-0 pt-[2vh]'>
                            ...
                            <form className='mx-8 w-full mt-8'>
                                ...
                                <div className='py-2 my-2 flex gap-2 flex-row justify-start'>
                                    <div className='w-[40%]'>
                                        <input className='hover:bg-[#2c3f50] outline-none focus:outline-blue-500 outline-[2px] bg-[#22303c] pl-5 w-full h-14 border-none text-white rounded-3xl' placeholder='Frist Name'></input>
                                    </div>
                                    <div className='w-[40%]'>
                                        <input className='hover:bg-[#2c3f50] outline-none focus:outline-blue-500 outline-[2px] bg-[#22303c] pl-5 w-full h-14 border-none text-white rounded-3xl' placeholder='Last Name'></input>
                                    </div>
                                </div>
                                <div>
                                ...
                                <div className='w-[82%]'>
                                    <div className='my-2 py-2' >
                                        <input className='hover:bg-[#2c3f50] outline-none focus:outline-blue-500 outline-[2px] bg-[#22303c] pl-5 w-full h-14 border-none text-white rounded-3xl' placeholder='Email' />
                                    </div>
                                    <div className='my-2 py-2' >
                                        <input className='hover:bg-[#2c3f50] bg-[#22303c] pl-5 w-full h-14 border-none outline-none focus:outline-blue-500 outline-[2px] text-white rounded-3xl' placeholder='Password' />
                                    </div>
                                    <div className='my-2 py-2' >
                                        <input className='hover:bg-[#2c3f50] bg-[#22303c] pl-5 w-full h-14 border-none outline-none focus:outline-blue-500 outline-[2px] text-white rounded-3xl' placeholder='Comfirm Password' />
                                    </div>
                                    <div className='flex my-5 justify-between flex-row'>
                                        ...
                                        <button className='text-white bg-blue-500 hover:bg-blue-600 border-none border rounded-3xl h-12 w-[40%]'>create account</button>
                                    </div>
                                    <div className='my-2 py-2' >
